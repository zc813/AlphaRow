...
def optimize(databuffer, out_weights, optimizer, metrics=None, batch_size=32, epochs=50, verbose=1, callbacks=None):
    model = new_model()
...
def new_logic():
    logic = ModelBasedMCTSLogic(new_model(), iterations=mcts_iterations)
    return logic
